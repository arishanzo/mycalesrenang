...
export const coreValues = [
  ...
  icon: (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
      <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v1.5a1.5 1.5 0 0 1-3 0V4H3v1.5a1.5 1.5 0 0 1-3 0V4zm0 7.5A1.5 1.5 0 0 0 1.5 13h13a1.5 1.5 0 0 0 1.5-1.5V11a2 2 0 0 0-2-2H2a2 2 0 0 0-2 2v.5z"/>
    </svg>
  )
},

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-start">
          ...
          <div ref={leftRef} className="flex flex-col gap-6">
              ...
              {CONTACT_ITEMS.map((item, i) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-xs text-marine-400 font-baloo font-semibold tracking-wider uppercase mb-0.5">
                      {item.label}
                    </p>
                    {item.href ? (
                      <a
            ...
            <div className="premium-card-glass rounded-2xl p-6">
              <p className="text-xs font-baloo font-bold text-marine-400 uppercase tracking-wider mb-4">
            ...
            <div className="premium-dark-card rounded-2xl p-6 text-white">
              <p className="text-xs font-baloo text-cyan-400 tracking-widest uppercase font-semibold mb-4">

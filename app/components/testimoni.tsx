    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="inline-flex items-center text-xs font-mono font-bold tracking-widest text-cyan-400 uppercase bg-marine-900/60 border border-marine-800 px-4 py-1.5 rounded-full mb-3">
            KATA MEREKA
          </span>
            ...
            >
              ...
              <div>
                ...
                <div className="flex gap-1 text-amber-500 mb-4 items-center">
                  ...
                  <span className="text-xs font-mono text-marine-300 ml-1">5.0 / 5.0</span>
                </div>
